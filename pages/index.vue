      ...
      <header class="mb-16 animate-fade-in">
        ...
        <div class="text-lg leading-relaxed">
          <p class="mb-6">
            ...
            others, making cool things, and hating big tech as a full-time
            hobby. Not only that, but I also like chickens 🐔. (Not to eat them,
            don't worry :D)
          </p>
        </div>
      </header>
      ...
      <section class="mb-16 animate-slide-up text-center">
        <div class="relative overflow-hidden">
          <div class="relative z-20">
            ...
            >
              Well, that's me! If you have questions about my work, don't
              hesitate to reach out. And please click the Button so my Plausible
              Instance can track that you read this far. I would be very happy
              about that! 😄
            </p>
            <button
