export default defineNuxtConfig({
  ...
  app: {
    ...
    meta: [
      ...
      { name: 'twitter:description', content: 'Explore Wuemeli\'s web development portfolio, including Nuxt.js and Discord.js projects. Get inspired by innovative solutions and creative designs.' }, // Twitter card description
    ],
