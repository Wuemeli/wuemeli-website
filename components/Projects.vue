    ...
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      ...
      >
        ...
        <p class="text-gray-300 text-sm mb-3">
          A mod for Minecraft that adds various quality-of-life features.
        </p>
        <a
      ...
      >
        ...
        <p class="text-gray-300 text-sm mb-3">
          My Gameserver hosting company. Entire infrastructure has been custom
          coded.
        </p>
        <a
      ...
      >
        ...
        <p class="text-gray-300 text-sm mb-3">
          Create Tor Relay servers easily using a config generator and a script.
        </p>
        <a
